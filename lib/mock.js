...
Router.prototype.handle = function (req, res) {
  ...
  var handled = _.some(this.stack, function (layer) {
    ...
    if (layer.match(url.pathname)) {
      ...
      req.params = _.merge({}, req.query, req.body, layer.params);

      var options = strict ? methods[method] : getOptions(methods, method, req.params);
      ...
      } else if (options.timeout === true || _.isNumber(options.timeout)) {
